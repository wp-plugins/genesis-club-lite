...
A toolbox of useful customisation functions for Genesis Child Themes.

== Description ==
* Include logo image in the title instead of text and tagline
* Add an author signature at the foot of each post
* Add extra widget areas at the top or foot of each post 
* Change "read more..." label 
* Change commentary label "Speak Your Mind"
* Change breadcrumb labels such "Archives for"
...
* Compatible with Genesis 1.9.x and Genesis 2.0 beta with HTML5 support
...
* Genesis Club Pro Plugin: http://www.diywebmastery.com/plugins/genesis-club-pro/
* Genesis Club Coaching Club: http://www.genesisclub.co/
