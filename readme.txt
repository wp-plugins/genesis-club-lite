...
Mobile Responsive Logos, Hamburger Menus, Animated Top Bars, FAQ Accordions, User Signatures, Label Overrides and much more for Genesis sites
...
* Easy to add Google Fonts and Google Font Effects
...
* Genesis Club Posts widget allows you to target the post syou want with its powerful selection by post type, taxonomy, with individual post inclusion and exclusions
...
* Customize your WordPress login witgh a background image, logo, user label and button color.
...
= 1.7 = Optional - Google Fonts, new Posts widget, Customized Login Page
