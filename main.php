...
if (!defined('GENESIS_CLUB_VERSION')) define('GENESIS_CLUB_VERSION','1.6');
...
if (!defined('GENESIS_CLUB_NEWS')) define('GENESIS_CLUB_NEWS', 'http://www.genesisclub.co/wordpress-coaching/newsfeed/feed/?images=&featured_only');
